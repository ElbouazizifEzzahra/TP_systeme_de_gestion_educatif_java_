...
import phase1.Main;
public class ControlleurDepartemant {
        ...
        public static void createDepartement(){
           ...
           ControlleurEnseignant.showEnseignants();
            ...
            ServicesDepartemant.addDept(intitule, ServicesEnsignant.getEnsById(id));
        ...
        public static void editDepartement(){
            ...
            ServicesDepartemant.updateDept(id, intitule, ServicesEnsignant.getEnsById(idEns));
        ...
        public static void destroyDepartement(){
            showDepartements();
            int id = Main.getIntInput("Sélecionnez un departement par id :");
            ServicesDepartemant.deleteDeptById(id);
            showDepartements();
